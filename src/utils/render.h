...
public:
    ...
    static void RegisterCoronaDirectional(const VehicleDummyConfig *pConfig, float angle, float radius, float szMul = 1.0f, bool inversed = false, bool skipCheck = true);
    ...
    static void RegisterShadowDirectional(const VehicleDummyConfig *pConfig, const std::string &shadwTexName, float shdwSz);
};