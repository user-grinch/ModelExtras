...
public:
    ...
    static void RegisterCoronaDirectional(const VehicleDummyConfig *pConfig, float angle, float radius, float szMul = 1.0f, bool checks = false, bool inversed = false);
