...
private:
  ...
  static constexpr uint32_t CHARSET_COL_WIDTH{
      4 * CHARSET_CHAR_WIDTH}; // 4x chars / row
  ...
  static RpMaterial *__cdecl CCustomCarPlateMgr_SetupMaterialPlatebackTexture(
  ...
  static RwTexture *CCustomCarPlateMgr_CreatePlateTexture(char *text,
                                                          uint8_t plateType);
  static bool CCustomCarPlateMgr_RenderLicenseplateTextToRaster(
