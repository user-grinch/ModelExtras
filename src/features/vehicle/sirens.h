...
public:
  ...
  int GetCurrentState() { return State; }
...
private:
  ...
  static void
  hkRegisterCorona(unsigned int id, CEntity *attachTo, unsigned char red,
                   unsigned char green, unsigned char blue, unsigned char alpha,
                   CVector const &posn, float radius, float farClip,
                   ...
                   float nearClip, unsigned char fadeState, float fadeSpeed,
                   bool onlyFromBelow, bool reflectionDelay);
  static void __cdecl hkAddPointLights(uint8_t type, CVector point, CVector dir,
