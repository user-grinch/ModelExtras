...
private:
	...
	static inline uintptr_t ORIGINAL_RwTexDictionaryFindNamedTexture2 = 0;
	...
	static RwTexture *Custom_RwTexDictionaryFindNamedTexture(RwTexDictionary *dict, const char *name);
	static RwTexture *__cdecl hkRwTexDictionaryFindNamedTexture(RwTexDictionary *dict, const char *name);
	static RwTexture *__cdecl hkRwTexDictionaryFindNamedTexture2(RwTexDictionary *dict, const char *name);
